...
from BlackThon.helpers.functions.functions import translate
try:
    from yaml import safe_load
except ModuleNotFoundError:
    from BlackThon.helpers.functions.functions import safe_load
...
for file in glob("BlackThon/strings/*yml"):
