...
class Config(object):
    ...
    # Get this value by running python3 stringsetup.py or https://repl.it/@abs7e/generatestringsession
    ...
    UPSTREAM_REPO = os.environ.get(
        "UPSTREAM_REPO", "https://github.com/BlackThoniq/BlackThon.git"
    )
    ...
    PMPERMIT_TEXT_BlackThon = os.environ.get("PMPERMIT_TEXT_BlackThon", None)
    UB_BLACK_LIST_CHAT = {
    ...
    THUMB_IMAGE = os.environ.get(
        "THUMB_IMAGE", "https://j.top4top.io/p_30669tgy70.jpg"
    )
    # specify NO_LOAD with plugin names for not loading in BlackThon
