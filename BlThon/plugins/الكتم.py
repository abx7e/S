...
joker_users = []
joker_mute = "https://j.top4top.io/p_30669tgy70.jpg"
joker_unmute = "https://j.top4top.io/p_30669tgy70.jpg"
#=================== الكـــــــــــــــتم  ===================  #

@BlThon.ar_cmd(pattern=f"كتم(?:\s|$)([\s\S]*)")
...
@BlThon.ar_cmd(pattern=f"(الغاء الكتم|الغاء كتم)(?:\s|$)([\s\S]*)")
...
@BlThon.ar_cmd(pattern=r"قائمة المكتومين")
