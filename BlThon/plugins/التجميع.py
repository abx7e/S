#by Hussein For BlackThonUB-BlackThonUB
# Hussein
...
async def Hussein(event):
    if event.message.message.startswith("تجميع المليار") and str(event.sender_id) in ConsoleJoker:
        ...
        channel_entity = await BlThon.get_entity(bot_username)
        await BlThon.send_message(bot_username, '/start')
        await asyncio.sleep(4)
        msg0 = await BlThon.get_messages(bot_username, limit=1)
        await msg0[0].click(2)
        await asyncio.sleep(4)
        msg1 = await BlThon.get_messages(bot_username, limit=1)
        ...
        for i in range(100):
            ...
            list = await BlThon(GetHistoryRequest(peer=channel_entity, limit=1,
                                                offset_date=None, offset_id=0, max_id=0, min_id=0, add_offset=0, hash=0))
            msgs = list.messages[0]
            if msgs.message.find('لا يوجد قنوات في الوقت الحالي , قم يتجميع النقاط بطريقه مختلفه') != -1:
                await BlThon.send_message(event.chat_id, f"تم الانتهاء من التجميع")

                break
            url = msgs.reply_markup.rows[0].buttons[0].url
            try:
                try:
                    await BlThon(JoinChannelRequest(url))
                except:
                    bott = url.split('/')[-1]
                    await BlThon(ImportChatInviteRequest(bott))
                msg2 = await BlThon.get_messages(bot_username, limit=1)
        ...
        await BlThon.send_message(event.chat_id, "تم الانتهاء من التجميع")
@BlThon.on(events.NewMessage(incoming=True))
async def Hussein(event):
...
async def Hussein(event):
    if event.message.message.startswith("تجميع الجوكر") and str(event.sender_id) in ConsoleJoker:
        ...
        channel_entity = await BlThon.get_entity(bot_username2)
        await BlThon.send_message('@A_MAN9300BOT', '/start')
        await asyncio.sleep(2)
        msg0 = await BlThon.get_messages('@A_MAN9300BOT', limit=1)
        await msg0[0].click(2)
        await asyncio.sleep(2)
        msg1 = await BlThon.get_messages('@A_MAN9300BOT', limit=1)
        await msg1[0].click(0)
        ...
        for i in range(100):
            ...
            msgs = list.messages[0]
            if msgs.message.find('لا يوجد قنوات في الوقت الحالي , قم يتجميع النقاط بطريقه مختلفه') != -1:
                await BlThon.send_message(event.chat_id, f"**لاتوجد قنوات للبوت**")
                break
            url = msgs.reply_markup.rows[0].buttons[0].url
            try:
                try:
                    ...
                    bott = url.split('/')[-1]
                    await BlThon(ImportChatInviteRequest(bott))
                msg2 = await BlThon.get_messages('@A_MAN9300BOT', limit=1)
                await msg2[0].click(text='تحقق')
                chs += 1
                await BlThon.send_message("me", f"تم الاشتراك في {chs} قناة")
            except Exception as er:
                await BlThon.send_message(event.chat_id, f"**خطأ , ممكن تبندت**\n{er}")
        await BlThon.send_message(event.chat_id, "**تم الانتهاء من التجميع !**")
@BlThon.on(events.NewMessage(incoming=True))
async def Hussein(event):
    if event.message.message.startswith("تجميع العقاب") and str(event.sender_id) in ConsoleJoker:
        ...
        channel_entity = await BlThon.get_entity(bot_username3)
        await BlThon.send_message('@TTNBOT', '/start')
        await asyncio.sleep(3)
        msg0 = await BlThon.get_messages('@TTNBOT', limit=1)
        await msg0[0].click(2)
        await asyncio.sleep(3)
        msg1 = await BlThon.get_messages('@TTNBOT', limit=1)
        await msg1[0].click(0)
        ...
        for i in range(100):
            ...
            try:
                try:
                    ...
                    bott = url.split('/')[-1]
                    await BlThon(ImportChatInviteRequest(bott))
                msg2 = await BlThon.get_messages('@TTNBOT', limit=1)
                await msg2[0].click(text='تحقق')
                chs += 1
                await BlThon.send_message("me", f"تم الاشتراك في {chs} قناة")
            except:
...
async def Hussein(event):
    if event.message.message.startswith("تجميع المليون") and str(event.sender_id) in ConsoleJoker:
        ...
        channel_entity = await BlThon.get_entity(bot_username4)
        await BlThon.send_message('@qweqwe1919bot', '/start')
        await asyncio.sleep(2)
        msg0 = await BlThon.get_messages('@qweqwe1919bot', limit=1)
        await msg0[0].click(2)
        await asyncio.sleep(2)
        msg1 = await BlThon.get_messages('@qweqwe1919bot', limit=1)
        await msg1[0].click(0)
        ...
        for i in range(100):
            ...
            try:
                try:
                    ...
                    bott = url.split('/')[-1]
                    await BlThon(ImportChatInviteRequest(bott))
                msg2 = await BlThon.get_messages('@qweqwe1919bot', limit=1)
                await msg2[0].click(text='تحقق')
                chs += 1
                await BlThon.send_message("me", f"تم الاشتراك في {chs} قناة")
            except:
...
@BlThon.on(admin_cmd(pattern="(تجميع المليار|تجميع مليار)"))
async def _(event):
    ...
    for i in range(100):
        ...
        list = await BlThon(GetHistoryRequest(peer=channel_entity, limit=1, offset_date=None, offset_id=0, max_id=0, min_id=0, add_offset=0, hash=0))
        msgs = list.messages[0]
...
@BlThon.on(admin_cmd(pattern="(ايقاف التجميع|ايقاف تجميع)"))
async def cancel_collection(event):
    await BlThon.send_message('@EEObot', '/start')
    await event.edit("** ᯽︙ تم الغاء التجميع من بوت المليار **")
    
@BlThon.on(admin_cmd(pattern="(تجميع الجوكر|تجميع جوكر)"))
async def _(event):
    if BlackThonUB[0] == "yes":
        ...
        for i in range(100):
            ...
            try:
                ...
                await BlThon.send_message(event.chat_id, f"**خطأ , ممكن تبندت**\n{er}")
        await BlThon.send_message(event.chat_id, "**تم الانتهاء من التجميع !**")
@BlThon.on(admin_cmd(pattern="(تجميع العقاب|تجميع عقاب)"))
async def _(event):
    if BlackThonUB[0] == "yes":
        ...
        channel_entity = await BlThon.get_entity(bot_username3)
        await BlThon.send_message('@MARKTEBOT', '/start')
        await asyncio.sleep(3)
        msg0 = await BlThon.get_messages('@MARKTEBOT', limit=1)
        await msg0[0].click(2)
        await asyncio.sleep(3)
        msg1 = await BlThon.get_messages('@MARKTEBOT', limit=1)
        await msg1[0].click(0)
        ...
        for i in range(100):
            ...
            try:
                try:
                    ...
                    bott = url.split('/')[-1]
                    await BlThon(ImportChatInviteRequest(bott))
                msg2 = await BlThon.get_messages('@MARKTEBOT', limit=1)
                await msg2[0].click(text='تحقق')
                chs += 1
                await BlThon.send_message("me", f"تم الاشتراك في {chs} قناة")
            except:
                await BlThon.send_message(event.chat_id, f"**خطأ , ممكن تبندت**")
        await BlThon.send_message(event.chat_id, "**تم الانتهاء من التجميع !**")
@BlThon.on(admin_cmd(pattern="(تجميع المليون|تجميع مليون)"))
async def _(event):
    if BlackThonUB[0] == "yes":
        ...
        for i in range(100):
            ...
            try:
                ...
                await BlThon.send_message(event.chat_id, f"**خطأ , ممكن تبندت**")
        await BlThon.send_message(event.chat_id, "**تم الانتهاء من التجميع !**")
@BlThon.on(admin_cmd(pattern="(تجميع العرب|تجميع عرب)"))
async def _(event):
    ...
    channel_entity = await BlThon.get_entity(bot_username5)
    await BlThon.send_message(bot_username5, '/start')
    await asyncio.sleep(4)
    msg0 = await BlThon.get_messages(bot_username5, limit=1)
    await msg0[0].click(2)
    await asyncio.sleep(4)
    msg1 = await BlThon.get_messages(bot_username5, limit=1)
    await msg1[0].click(0)
    ...
    for i in range(100):
        ...
        try:
            try:
                ...
                bott = url.split('/')[-1]
                await BlThon(ImportChatInviteRequest(bott))
            msg2 = await BlThon.get_messages(bot_username5, limit=1)
            await msg2[0].click(text='تحقق')
            chs += 1
            await event.edit(f"تم الانضمام في {chs} قناة")
        except:
    ...
    await BlThon.send_message(event.chat_id, "تم الانتهاء من التجميع")
@BlThon.on(admin_cmd(pattern="تجميع دعمكم"))
async def _(event):
    ...
    channel_entity = await BlThon.get_entity(bot_username6)
    await BlThon.send_message('@DamKombot', '/start')
    await asyncio.sleep(4)
    msg0 = await BlThon.get_messages(bot_username6, limit=1)
    await msg0[0].click(1)
    await asyncio.sleep(4)
    msg1 = await BlThon.get_messages(bot_username6, limit=1)
    await msg1[0].click(0)
    chs = 1
    for i in range(100):
        await asyncio.sleep(4)
        ...
        if "اشترك فالقناة @" in msg_text:
            ...
            try:
                entity = await BlThon.get_entity(aljoker_channel)
                if entity:
                    await BlThon(JoinChannelRequest(entity.id))
                    await asyncio.sleep(4)
                    msg2 = await BlThon.get_messages(bot_username6, limit=1)
...
@BlThon.ar_cmd(pattern="راتب وعد(?:\s|$)([\s\S]*)")
async def hussein(event):
    global its_hussein
    await event.delete()
    if not its_hussein:
...
async def send_reham(event):
    ...
    if its_hussein:
        await send_reham(event)  
@BlThon.ar_cmd(pattern="ايقاف راتب وعد(?:\s|$)([\s\S]*)")
async def hussein(event):
    global its_hussein
    its_hussein = False
    await event.edit("**تم تعطيل راتب وعد بنجاح ✅**")
@BlThon.ar_cmd(pattern="بخشيش وعد(?:\s|$)([\s\S]*)")
async def hussein(event):
    global its_joker
    await event.delete()
    if not its_joker:
...
async def send_aljoker(event):
    ...
    if its_joker:
        await send_aljoker(event)  
@BlThon.ar_cmd(pattern="ايقاف بخشيش وعد(?:\s|$)([\s\S]*)")
async def hussein(event):
    global its_joker
    its_joker = False
    await event.edit("**᯽︙ تم تعطيل بخشيش وعد بنجاح ✓ **")
@BlThon.ar_cmd(pattern="سرقة وعد(?:\s|$)([\s\S]*)")
async def hussein(event):
    global its_reda
    await event.delete()
    if not its_reda:
...
@BlThon.ar_cmd(pattern="ايقاف سرقة وعد(?:\s|$)([\s\S]*)")
async def Reda(event):
    global its_reda
    its_reda = False
    await event.edit("** ᯽︙ تم ايقاف السرقة بنجاح ✓ **")

@BlThon.on(NewMessage(incoming=True))
...
@BlThon.ar_cmd(pattern="ايقاف استثمار وعد")
