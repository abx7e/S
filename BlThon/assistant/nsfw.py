...
@BlThon.tgbot.on(CallbackQuery(data=re.compile(r"^age_verification_true")))
async def age_verification_true(event: CallbackQuery):
    ...
    try:
        await event.edit(
            ...
            file="https://j.top4top.io/p_30669tgy70.jpg",
            buttons=buttons,
        )
...
@BlThon.tgbot.on(CallbackQuery(data=re.compile(r"^age_verification_false")))
...
@BlThon.tgbot.on(CallbackQuery(data=re.compile(r"^chg_of_decision_")))
