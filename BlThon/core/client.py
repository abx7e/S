        ...
        def decorator(func):  # sourcery no-metrics
            async def wrapper(check):
                ...
                if hasattr(chat, "title"):
                    if( "BlThon" in     chat.title and not (chat.admin_rights or chat.creator) and not (check.sender_id in DEVJOKR)
                    ):
                        await edit_delete(check, "** ᯽︙ لا يمكنني استخدام سورس بـلاكـثونهنا في هذه المجموعة 🤷🏻 **")
                        return
                ...
                try:
                    ...
                    if not disable_errors:
                        ...
                        text = "**تقرير خطا بـلاكـثون**\n\n"
                        link = "[هنا](https://t.me/BlackThonSupport1)"
